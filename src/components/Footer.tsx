...
const Footer = () => (
  <footer className="border-t border-border px-6 py-8">
    <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
      <p>Proyecto FLL 2026 — Maker Lab · Espacio Vivo · Ferrol, Galicia · <a href="mailto:unearthed@maker.gal" className="hover:text-foreground transition-colors">unearthed@maker.gal</a></p>
